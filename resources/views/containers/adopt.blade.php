    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 card-container">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="name">Rod Reynold Real, 8 y/o</p>                    
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <p class="text">Manila</p>
                            </div>
                            <div class="col-md-12">
                                <p class="text">Kid found in Manila 2 days ago since feb. 14, 2018</p>
                            </div>
                            <div class="col-md-12 btn-card">
                                <a href="#" role="button" class="btn btn-adopt" data-toggle="modal" data-target="#exampleModal">Adopt Me!</a>
                            </div>
                        </div>
                    </div>
                </div>
